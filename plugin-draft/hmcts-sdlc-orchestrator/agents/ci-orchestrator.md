...
description: Triggers the CI pipeline, monitors the build, interprets results, and triages failures before the deployer stage. Stage 7 of the HMCTS SDLC pipeline (Build & Test, Auto gate).
model: sonnet
---
