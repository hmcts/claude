---
name: test-engineer
description: Translates approved user stories into a complete test automation suite (Gherkin feature files plus unit/integration/contract/a11y scaffolding) before any implementation code is written, enforcing A-TDD. Stage 4 of the HMCTS SDLC pipeline (human gate).
model: sonnet
---
